...
void ExpressionConvertingMatrix::createMatrix(){
	...
	inputArray[VALUE_TOKEN_PLUS].topSTwoArray[VALUE_TOKEN_EXPONENT] = ACTION_TOKEN_U_ONE;
	...
	inputArray[VALUE_TOKEN_MINUS].topSTwoArray[VALUE_TOKEN_EXPONENT] = ACTION_TOKEN_U_ONE;
	...
	inputArray[VALUE_TOKEN_TIMES].topSTwoArray[VALUE_TOKEN_EXPONENT] = ACTION_TOKEN_U_ONE;
	...
	inputArray[VALUE_TOKEN_DIVIDE].topSTwoArray[VALUE_TOKEN_EXPONENT] = ACTION_TOKEN_U_ONE;
