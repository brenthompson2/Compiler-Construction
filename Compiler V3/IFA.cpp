...
void IFA::prepareIFA(FileManager *parentFileManager, SymbolTable *parentMemoryManager, LineLabelTable *parentLineManager){
...
// returns num errors
int IFA::handleIFA(string currentLine, int correspondingLineNumber){
...
bool IFA::parseVariable(int *currentCharIterator, int parameterNumber){
	char currentChar;
...
bool IFA::parseLineLabelName(int *currentCharIterator, int parameterNumber){
	char currentChar;
...
void IFA::syncVariablesToSymbolTable(){
