...
void LISTO::prepareLISTO(FileManager *parentFileManager){
	currentFileManager = parentFileManager;
}

// calls the functions necessary to parse the line and print the object code to the file while counting errors
// returns num errors
int LISTO::handleLISTO(string currentLine, int correspondingLineNumber){
