...
void NOP::outputNOPCommand(){
	// cout << "\t\t[NOP]: Attempting to Print Object code to .obj...\n";

	(*currentFileManager).writeCharToObj(NOP_OP_CODE);
