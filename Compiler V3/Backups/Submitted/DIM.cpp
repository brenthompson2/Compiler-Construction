...
// returns num errors
int DIM::handleDIM(string currentLine, int correspondingLineNumber){
...
bool DIM::parseVariable(int *currentCharIterator, string *arrayName){
	char currentChar;
...
bool DIM::parseSize(int *currentCharIterator, int *arraySize){
	char currentChar;
...
void DIM::addToVariableArray(string currentArrayName, int currentArraySize){
