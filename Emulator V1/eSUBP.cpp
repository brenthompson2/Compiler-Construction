...
// returns num errors
int eSUBP::handleSUBP(string currentLine, int correspondingLineNumber){
...
void eSUBP::syncVariablesToSymbolTable(){
...
bool eSUBP::parseVariable(int *currentCharIterator, int parameterNumber){
...
// parses through a line one character at a time, manages the global member variable associated with the parameterNumber, and returns whether or not there are any more parameters to parse
bool eSUBP::parseConstant(int *currentCharIterator, int parameterNumber){
...
void eSUBP::parseOperation(int *currentCharIterator){
