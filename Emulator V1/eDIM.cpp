...
// returns num errors
int eDIM::handleDIM(string currentLine, int correspondingLineNumber){
...
bool eDIM::parseVariable(int *currentCharIterator, string *arrayName){
	char currentChar;
...
bool eDIM::parseSize(int *currentCharIterator, int *arraySize){
	char currentChar;
...
void eDIM::addToVariableArray(string currentArrayName, int currentArraySize){
...
void eDIM::syncVariableArrayToSymbolTable(){
