...
// returns num errors
int eIFA::handleIFA(string currentLine, int correspondingLineNumber){
...
bool eIFA::parseVariable(int *currentCharIterator, int parameterNumber){
	char currentChar;
...
bool eIFA::parseLineLabelName(int *currentCharIterator, int parameterNumber){
	char currentChar;
...
void eIFA::syncVariablesToSymbolTable(){
