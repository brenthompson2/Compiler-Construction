...
public:
	...
	bool prepareForCompilation(string fileName, int parentLinesOfCodeArray[], int *numLinesOfCodeInArray);
...
private:
	...
	bool writeNoBlanksFile(ifstream &inputFile, ofstream &noBlanksOutFile, int parentLinesOfCodeArray[], int *numLinesOfCodeInArray);
