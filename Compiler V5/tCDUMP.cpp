...
void tCDUMP::outputCDUMPCommand(){
	...
	(*currentFileManager).writeCharToObj(CDUMP_OP_CODE);
	(*currentFileManager).writeCharToObj(' ');

	(*currentFileManager).writeNumToObj(globalStartIndex.memoryLocation);
	(*currentFileManager).writeCharToObj(' ');

	(*currentFileManager).writeNumToObj(globalEndIndex.memoryLocation);
	(*currentFileManager).writeCharToObj('\n');
